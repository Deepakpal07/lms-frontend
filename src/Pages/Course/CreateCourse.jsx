    ...
    return(
        <HomeLayout>
           ...
           <form 
            ...
            >
                <Link className="absolute top-8 teat-2xl link text-accent cursor-pointer">
                    <AiOutlineArrowLeft />
                </Link>
                ...
                <main className="grid grid-cols-2 gap-x-10">
                    ...
                    <div className="flex flex-col gap-1">
                        <div className="flex flex-col gap-1">
                         ...
                         <div className="flex flex-col gap-1">
                            <label className="text-lg font-semibold" htmlFor="Course category">
                                Course category
                            </label>
                            <input
                                 required
                        ...
                        <div className="flex flex-col gap-1">
                            <label className="text-lg font-semibold" htmlFor="Course description">
                                Course description
                            </label>
                            <input
                                 required
